...
(function ($) {
   ...
   var ajaxloadmore = function ajaxloadmore(el, e) {
      ...
      alm.listing = container.querySelector('.alm-listing');
      ...
      *  Click Handler
      ...
      alm.AjaxLoadMore.scroll = function () {
         if (alm.AjaxLoadMore.isVisible() && !alm.fetchingPreviousPost) {
            ...
            var btnOffset = alm.button.offsetTop,
                top = Math.round(btnOffset - (alm.window.innerHeight - alm.scroll_distance)),
                scrollTrigger = alm.window.pageYOffset >= top ? true : false;
