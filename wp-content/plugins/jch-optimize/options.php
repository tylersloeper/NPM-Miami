...
function jch_initialize_settings()
{
	...
	wp_register_script('jch-wordpress-js', JCH_PLUGIN_URL . 'media/js/wordpress.js', array('jquery'), JCH_VERSION, true);
       ...
       // add_settings_field('jch_options_lifetime', __('Lifetime (days)', 'jch-optimize'), 'jch_options_lifetime_string', 'jch-sections', 'jch_basic_pre');
        ...
        add_settings_field('jch_options_auto_basic', '<strong><i>' . __('Automatic Basic Settings', 'jch-optimize') . '</i></strong><hr>', 'jch_options_auto_basic_string', 'jch-sections', 'jch_basic_auto');
        ...
        //add_settings_field('jch_options_removeCSS', __('Remove CSS files', 'jch-optimize'), 'jch_options_removeCss_string', 'jch-sections', 'jch_advanced_remove');
        //add_settings_field('jch_options_removeJs', __('Remove javascript files', 'jch-optimize'), 'jch_options_removeJs_string', 'jch-sections', 'jch_advanced_remove');
