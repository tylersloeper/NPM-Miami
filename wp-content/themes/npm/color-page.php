<?php /* Template Name: Colors Page Template */ get_header();
				...
				<section id="project_map">
                      ...
                      <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item nav-item-space">
                          <a class="nav-link active clickcolor1" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
						<!--	<img src="<?php //echo get_template_directory_uri(); ?>/img/11.png" alt="Logo" class="">-->
                          ...
                          <li class="nav-item nav-item-space">
                            <a class="nav-link  clickcolor2" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                        ...
                        <li class="nav-item nav-item-space">
                          <a class="nav-link clickcolor3" id="pills-profile-tab2" data-toggle="pill" href="#pills-profile2" role="tab" aria-controls="pills-profile2" aria-selected="false">
                          ...
                          <li class="nav-item nav-item-space">
                            <a class="nav-link clickcolor4" id="pills-profile-tab3" data-toggle="pill" href="#pills-profile3" role="tab" aria-controls="pills-profile3" aria-selected="false">
					                          ...
					                          <li class="nav-item nav-item-space">
					                            <a class="nav-link clickcolor5" id="pills-profile-tab4" data-toggle="pill" href="#pills-profile4" role="tab" aria-controls="pills-profile4" aria-selected="false">
												...
												<li class="nav-item nav-item-space">
												  <a class="nav-link clickcolor6" id="pills-profile-tab5" data-toggle="pill" href="#pills-profile5" role="tab" aria-controls="pills-profile5" aria-selected="false">
												...
												<li class="nav-item nav-item-space">
													<a class="nav-link clickcolor7" id="pills-profile-tab52" data-toggle="pill" href="#pills-profile52" role="tab" aria-controls="pills-profile52" aria-selected="false">
											...
											<!---new category--->
												...
												<li class="nav-item nav-item-space">
												  <a class="nav-link clickcolor8" id="pills-profile-tab6" data-toggle="pill" href="#pills-profile6" role="tab" aria-controls="pills-profile6" aria-selected="false">
												<!--<img src="<?php //echo get_template_directory_uri(); ?>/img/66_1.png" alt="Logo" class="">-->
...
<!--/ filter nedles-->
	...
	<!--strip 5 post closed--> 	<!---for desktop gallery >1025-->
				...
				<!--for mobile slider ok strip 5 <1025--->
